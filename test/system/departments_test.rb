...
class DepartmentsTest < ApplicationSystemTestCase
  ...
  test "creating a Department" do
    ...
    fill_in "Customer description", with: @department.customer_description
    fill_in "Internal description", with: @department.internal_description
    check "Is locked" if @department.is_locked
    fill_in "Learning description", with: @department.learning_description
    fill_in "Plan", with: @department.plan_id
    fill_in "Strategic description", with: @department.strategic_description
