...
class DashboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dashboard" do
    assert_difference('Dashboard.count') do
      post dashboards_url, params: { dashboard: { name: @dashboard.name, report_id: @dashboard.report_id, user_id: @dashboard.user_id } }
    end
  ...
  test "should update dashboard" do
    patch dashboard_url(@dashboard), params: { dashboard: { name: @dashboard.name, report_id: @dashboard.report_id, user_id: @dashboard.user_id } }
